$(document).ready(function(){
	...
	function displayUserAndFM(){
		...
		$(".style1").append(
			"<tr>"+
				"<td>Coverage Tier:</td>"+
				"<td>"+enrollmentPlan.coverageTier+"</td>"+
			"</tr>"	+
			"<tr>"+
				"<td>Premium:</td>"+
				"<td>"+enrollmentPlan.premium+"</td>"+
			"</tr>"	+
			"<tr>"+
				"<td>Deductable:</td>"+
				"<td>$"+enrollmentPlan.deductable+"</td>"+
			"</tr>"	+
			"<tr>"+
				"<td>Purchase Status:</td>"+
				"<td>"+enrollmentPlan.purchaseStatus+"</td>"+
			"</tr>"	+
			"<tr>"+
				"<td>Benefits:</td>"+
				"<td>"+
					enrollmentPlan.benefits[0].benefitName+" > "+enrollmentPlan.benefits[0].description +"<br/>"+
					enrollmentPlan.benefits[1].benefitName+" > "+enrollmentPlan.benefits[1].description +"<br/>"+
					enrollmentPlan.benefits[2].benefitName+" > "+enrollmentPlan.benefits[2].description +"<br/>"+
					enrollmentPlan.benefits[3].benefitName+" > "+enrollmentPlan.benefits[3].description +"<br/>"+
				"</td>"+
			"</tr>"+
			"<tr>"+
				"<td>User Address:</td>"+
